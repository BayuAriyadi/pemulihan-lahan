                        ...
                        <div class="authincation-content">
                            ...
                            <div class="col-xl-12">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        <label class="h9 text-gray-900 mb-1">Username</label>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="InputUsername" aria-describedby="username" placeholder="User Name">
                                        </div>
                                        <label class="h9 text-gray-900 mb-1">Password</label>
                                        <div class="form-group">
